...
const VerifyPage = () => {
  return (
    <div className="w-full p-5 bg-[#f9f9f9] px-12 lg:px-52 h-full text-[#333]">
      ...
      <div className="flex flex-col items-center gap-6 mt-6 shadow-lg bg-white p-5 px-8 lg:py-12">
        ...
        <button
          type="button"
          className=" p-2 bg-yellow hover:bg-blue-700 text-white text-sm px-3"
        >
          Click here to complete your KYC
        </button>
      </div>

      <div className="flex items-center gap-6 mt-12 shadow-lg bg-white p-5 px-4 lg:py-8">
        ...
        <button
          type="button"
          className=" p-2 border border-yellow hover:bg-blue-700 text-[#333] font-normal text-sm px-3"
        >
          Get support now
        </button>
      </div>
